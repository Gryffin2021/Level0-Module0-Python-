...
if __name__ == '__main__':
    ...
    liquid = simpledialog.askstring(title="Type of Liquid", prompt="Please enter a type of liquid.")
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title="Body Part", prompt="Please enter a body part.")
